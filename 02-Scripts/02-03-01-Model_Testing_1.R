...
## This is the first attempt to test the OpenAI model on a few articles.
...
# Save as CSV
write_csv(final_results, "03-Output/article_analysis_results_test_.csv")


## Conclusion: failed a lot of times. Because of that, 
# new file was created "02-03-02_Model_Testing_2"
